...
export const translations = {
    en: {
        ...
        hero: {
            ...
            description: "11+ years crafting scalable backend systems, automation pipelines, and full-stack solutions.",
    ...
    es: {
        ...
        hero: {
            ...
            description: "11+ años creando sistemas backend escalables, pipelines de automatización y soluciones full-stack.",
